...
int main(void) {
  std::cout << GREEN << "------ Test 1: empty array ------" << RESET
            << std::endl;
  ...
  try {
    std::cout << YELLOW << "Trying to access index 0: " << RESET << empty[0]
              << std::endl;
  ...
  // Test 2: array of 5 strings
  std::cout << GREEN << "------ Test 2: array of 5 strings ------" << RESET
            << std::endl;
  ...
  std::cout << GREEN << "------ Test 3: copy constructor ------" << RESET
            << std::endl;
  ...
  std::cout << GREEN << "------ Test 4: assignment operator ------" << RESET
            << std::endl;
  ...
  std::cout << GREEN << "------ Test 5: out of bounds exception ------" << RESET
            << std::endl;
